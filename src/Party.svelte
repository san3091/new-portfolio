...
<div class="party-container">
  <div class="description" in:fade={{delay: 300, duration: 500}} out:fade>
    <h1>The Night of One Thousand Santiagos</h1>
    ...
    <ul class="list">
      <li>The nine summoned homosexuals shall have a socially distant hangout in my front yard, the address of which will be texted to you.</li>
    ...
    <p>For your pleasure and to jog your memory, <span class="link"><Link to="1000-santiagos-inspiration">I have assembled a collection of various santiagos starting 2007.</Link></span> I am also violently active on instagram and have documented every year of my life since 2012 there—feel free to roam.</p>
  </div>
</div>
